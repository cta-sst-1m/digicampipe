...
# digicam-fmpe --debug --fit --output=$fmpe_folder --estimated_gain=$estimated_gain --n_samples=$n_samples --shift=$shift --integral_width=$integral_width --timing=$timing_folder'timing_results.npz' /sst1m/raw/2018/06/28/SST1M_01/SST1M_01_20180628_{1350..1454}.fits.fz
