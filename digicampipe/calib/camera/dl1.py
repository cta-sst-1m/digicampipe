...
def calibrate_to_dl1(
    ...
    for i, event in enumerate(event_stream):
        ...
        for telescope_id in event.r0.tels_with_data:
            ...
            adc_integrated, gain = breakout_start_part(
                r0_camera,
                adc_samples,
                dl1_camera,
                time_integration_options
            )
            breakout_extract_charge(
                dl1_camera,
                time_integration_options,
                gain,
                adc_integrated)
...
def breakout_while_loop(dl1_camera, pixel_id, geom, boundary_threshold):
...
def breakout_end_part(dl1_camera, geom, additional_mask):
...
def breakout_start_part(r0_camera, adc_samples, dl1_camera, time_integration_options):
    mask_for_cleaning = (
