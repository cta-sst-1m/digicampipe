...
def compute_discrimination_variable(r0_container, patch_coordinates):
    ...
    output_trigger_patch7 = np.array(list(r0_container.trigger_output_patch7.values()))
...
def skim_events(event_stream):
    ...
    discrimination_variable = {'time_trigger': [], 'time_total': [], 'time_max': [], 'n_patches': [], 'shower_spread': []}
    ...
    for event_number, event in enumerate(event_stream):
        ...
        for telescope_id in event.r0.tels_with_data:
            ...
            trigger_time, total_time_above_threshold, max_time_above_threshold, n_patches_above_threshold, sigma = \
                compute_discrimination_variable(r0_container, patch_coordinates)
