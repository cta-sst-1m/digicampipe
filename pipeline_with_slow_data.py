...
if __name__ == '__main__':
    ...
    drive_system_file_list = [
        '/mnt/sst1m_data/aux/2017/10/30/SST1M_01/DriveSystem_20171030_%03d.fits'
    ]
    file_list = ['./data/SST1M01_0_000.090.fits.fz']
    # slowcontrol_folder = '/mnt/sst1m_data/aux/2017/10/30/SST1M_01/'
    ...
    pixel_not_wanted = [1038, 1039, 1002, 1003, 1004,
