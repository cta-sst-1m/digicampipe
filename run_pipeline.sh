...
digicam-pipeline --compute --display --output=./hillas.fits --dark=raw_histo.pk --parameters=digicampipe/tests/resources/calibration_20180814.yml --template=digicampipe/tests/resources/pulse_SST-1M_pixel_0.dat $science_files