...
digicam-fmpe --charge_histo_filename=$FMPE_CHARGE_HISTO --amplitude_histo_filename=$FMPE_AMPLITUDE_HISTO --results_filename=$FMPE_RESULTS --pixels=$(tolist "${DIGICAM_PIXELS[@]}") --figure_path=$DIGICAM_FOLDER'figures/fmpe.pdf' --estimated_gain=$DIGICAM_GAIN_APPROX --n_samples=$DIGICAM_N_SAMPLES --shift=$DIGICAM_INTEGRAL_SHIFT --integral_width=$DIGICAM_INTEGRAL_WIDTH --timing=$TIMING_RESULTS ${DIGICAM_AC_FILES[@]}
