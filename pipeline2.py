...
if __name__ == '__main__':
    ...
    file_list = [filename % number for number in range(10,24)]
    camera_config_file = '/data/software/CTS/config/camera_config.cfg'
    dark_baseline = np.load('/calib_data/second_light/CRAB_01/dark.npz')
    ...
    data_stream = filter.filter_bigshower(data_stream, min_photon=10000)
